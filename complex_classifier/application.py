...
if __name__ == '__main__':
    ...
    print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
    print('SciPy fits:')
    params = get_all_scipy_preds(data_x=data_x, data_y=data_y, with_bounds=False)
    ...
    class_pred      = get_classifier_preds(data_y=data_y, data_x=data_x, 
    ...
    params_nnsc = get_all_nnsc_preds(model_path=dir_regressors, data_x=data_x, data_y=data_y, with_bounds=False)
